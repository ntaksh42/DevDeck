...
このページは、AzDoDeck で使われている技術を **1つずつ「何者か」** を平易に説明します。
...
AzDoDeck は、性格の違う2つの部分が合体してできています。
...
- **補足**: Electron という似た道具より軽量です。AzDoDeck はブラウザ機能を丸ごと同梱せず、
...
- **このアプリでの役割**: 本物のデータの置き場所。AzDoDeck はここから情報を取得し、
  コメント投稿や投票などの操作を送ります。
