...
export const KEYBINDINGS: readonly Keybinding[] = [
  ...
  { id: "gotoTriage", label: "Triage", group: "Go to view", defaultCombo: "T", scope: "goto" },
  { id: "gotoMyReviews", label: "My Reviews", group: "Go to view", defaultCombo: "R", scope: "goto" },
  { id: "gotoPullRequestSearch", label: "Pull Request Search", group: "Go to view", defaultCombo: "P", scope: "goto" },
